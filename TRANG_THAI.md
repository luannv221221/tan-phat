...
- **Phân hệ CSKH**: ✅ **XONG lát cắt CSKH-1** (18/07, migration `000019`, `CSKH_SPEC.md`): phiếu bảo hành/sửa chữa (luồng trạng thái) · lịch bảo hành (highlight quá hạn) · nhóm khách hàng (+`partners.group_id`) · **đánh giá SP TASK_84** (thành viên gửi→admin duyệt→hiện web) · báo cáo CSKH. Nhóm menu "CSKH". Hoãn: BB giao nhận, webchat, bản tin, nhắc lịch tự động.
...
- **Phân hệ Kho — Kho-2**: ✅ **XONG** (18/07, migration `000020`): điều chuyển kho (WH-05, bảo toàn giá vốn, không kế toán) + kiểm kê (WH-07, điều chỉnh thừa/thiếu + bút toán Nợ156/Có711 · Nợ632/Có156). Tựa lên StocksModel. Hoãn Kho-3: hàng tồn lâu, phân cấp 5 tầng.
