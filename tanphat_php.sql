...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 01, 2026 at 04:49 AM
...
--
-- Table structure for table `acc_cost_items`
--
...
--
-- Dumping data for table `acc_voucher_entries`
--
...
INSERT INTO `attributes` (`id`, `name`, `slug`, `unit`, `sort_order`, `status`, `create_at`, `update_at`) VALUES
...
INSERT INTO `login_token` (`id`, `user_id`, `token`, `create_at`, `client_ip`, `current_activity`) VALUES
(264, 15, '54f3631c0e63065a583b246f79723d7397bff72d7d27963c3a5e014beb5758e7', '2026-08-01 04:35:46', '222.252.24.15', '2026-08-01 04:43:25');
...
(2, NULL, 'Sản phẩm', 'san-pham', '_self', 1, 1, '2026-07-19 05:15:15', NULL),
(3, NULL, 'Khuyến mãi', 'san-pham?promo=1', '_self', 2, 1, '2026-07-19 05:15:15', NULL),
(4, NULL, 'Dự án', 'du-an', '_self', 3, 1, '2026-07-19 05:15:15', NULL),
(5, NULL, 'Thư viện', 'thu-vien', '_self', 4, 1, '2026-07-19 05:15:15', NULL),
(6, NULL, 'Tin tức', 'tin-tuc', '_self', 5, 1, '2026-07-19 05:15:15', NULL);
...
(13, 'Thương hiệu phụ tùng', 'product-brands', '2026-07-18 04:24:33', NULL),
...
(20, 'Danh mục phụ tùng', 'part-categories', '2026-07-18 04:24:33', NULL),
...
INSERT INTO `orders` (`id`, `order_no`, `member_id`, `customer_name`, `phone`, `email`, `address`, `note`, `payment_method`, `subtotal`, `total_amount`, `status`, `sales_invoice_id`, `create_at`, `update_at`) VALUES
(5, 'DH-000001', NULL, 'Trần Văn Nam', '0977111222', NULL, '15 Cầu Giấy, Hà Nội', NULL, 'cod', 675000.00, 675000.00, 'new', NULL, '2026-07-19 11:11:57', '2026-07-19 11:11:57'),
(6, 'DH-000002', NULL, 'Lê Thị Hoa', '0966333444', NULL, '78 Hai Bà Trưng, Hà Nội', NULL, 'bank_transfer', 159000.00, 159000.00, 'confirmed', NULL, '2026-07-19 11:11:57', '2026-07-19 11:11:57'),
(7, 'DH-000003', NULL, 'Phạm Quốc Việt', '0955666777', NULL, '230 Láng Hạ, Hà Nội', NULL, 'cod', 230000.00, 230000.00, 'completed', NULL, '2026-07-19 11:11:57', '2026-07-19 11:11:57'),
(8, 'DH-000004', NULL, 'sfgsad', 'sdgsdg', 'dsà', 'agdsdfa', NULL, 'bank_transfer', 627000.00, 627000.00, 'new', NULL, '2026-07-27 12:21:24', '2026-07-27 12:21:24'),
(9, 'DH-000005', NULL, 'sdfgsa', 'sdf', NULL, 's', NULL, 'cod', 1380000.00, 1380000.00, 'new', NULL, '2026-07-27 12:22:19', '2026-07-27 12:22:19');
...
--
-- Dumping data for table `part_fitments`
--
...
--
-- Table structure for table `part_related`
--
...
INSERT INTO `product_brands` (`id`, `name`, `slug`, `logo`, `sort_order`, `status`, `create_at`, `update_at`) VALUES
...
INSERT INTO `product_manufacturers` (`id`, `name`, `slug`, `sort_order`, `status`, `create_at`, `update_at`) VALUES
...
--
-- Dumping data for table `product_origins`
--

INSERT INTO `product_origins` (`id`, `name`, `slug`, `sort_order`, `status`, `create_at`, `update_at`) VALUES
...
INSERT INTO `product_reviews` (`id`, `part_id`, `member_id`, `author_name`, `rating`, `comment`, `status`, `create_at`) VALUES
...
INSERT INTO `product_units` (`id`, `name`, `slug`, `sort_order`, `status`, `create_at`, `update_at`) VALUES
...
INSERT INTO `projects` (`id`, `name`, `slug`, `meta_title`, `meta_description`, `client`, `location`, `summary`, `content`, `thumbnail`, `completed_at`, `is_published`, `sort_order`, `created_by`, `create_at`, `update_at`) VALUES
...
CREATE TABLE `sales_invoices` (
  ...
  `status` tinyint(1) NOT NULL DEFAULT 0,
  `acc_voucher_id` int(11) DEFAULT NULL,
  `einvoice_status` varchar(10) NOT NULL DEFAULT 'none',
  `einvoice_serial` varchar(20) DEFAULT NULL,
  `einvoice_form` varchar(20) DEFAULT NULL,
  `einvoice_no` varchar(30) DEFAULT NULL,
...
(15, 'Tạ Hoàng An', 'hoangan.web@gmail.com', '$2y$10$455HW.Y5hgKA33ZOHF6X5ex1enC.c1Rdo/B9KpSOcAPcXPG./CdJK', 1, 9, '2021-12-11 03:00:48', NULL, NULL, NULL, NULL),
...
--
-- Table structure for table `warranty_handovers`
--
...
--
-- Dumping data for table `warranty_handovers`
--
...
ALTER TABLE `acc_accounts`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uq_acc_accounts_code` (`code`),
  ADD KEY `idx_acc_accounts_parent` (`parent_id`);

--
-- Indexes for table `acc_cost_items`
--
ALTER TABLE `acc_cost_items`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uq_acc_cost_items_code` (`code`);

--
-- Indexes for table `acc_projects`
--
ALTER TABLE `acc_projects`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uq_acc_projects_code` (`code`);
...
ALTER TABLE `acc_vouchers`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uq_acc_vouchers_no` (`voucher_no`),
  ADD KEY `idx_acc_vouchers_date` (`voucher_date`),
  ADD KEY `idx_acc_vouchers_cash` (`cash_account_id`),
  ADD KEY `idx_acc_vouchers_partner` (`partner_id`);
...
ALTER TABLE `acc_voucher_entries`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_ave_voucher` (`voucher_id`),
  ADD KEY `idx_ave_account` (`account_id`),
  ADD KEY `fk_ave_cost_item` (`cost_item_id`),
  ADD KEY `fk_ave_project` (`project_id`),
  ADD KEY `fk_ave_debit` (`debit_account_id`),
  ADD KEY `fk_ave_credit` (`credit_account_id`);
...
ALTER TABLE `banners`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_banners_status_sort` (`status`,`sort_order`);
...
ALTER TABLE `car_body_types`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uq_car_body_types_slug` (`slug`);
...
ALTER TABLE `car_brands`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uq_car_brands_slug` (`slug`),
  ADD KEY `idx_car_brands_status` (`status`);
...
ALTER TABLE `car_colors`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uq_car_colors_slug` (`slug`);
...
ALTER TABLE `car_fuels`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uq_car_fuels_slug` (`slug`);
...
ALTER TABLE `car_models`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uq_car_models_brand_slug` (`brand_id`,`slug`),
  ADD KEY `idx_car_models_brand` (`brand_id`),
  ADD KEY `idx_car_models_body` (`body_type_id`);
...
ALTER TABLE `car_years`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_car_years_model` (`model_id`),
  ADD KEY `idx_car_years_range` (`year_from`,`year_to`);
...
ALTER TABLE `chat_conversations`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uq_chat_session` (`session_key`),
  ADD KEY `idx_chat_member` (`member_id`);
...
ALTER TABLE `employees`
  ...
  ADD KEY `idx_emp_pos` (`position_id`);
...
ALTER TABLE `gallery_items`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_gi_gallery` (`gallery_id`);
...
ALTER TABLE `goods_issues`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uq_issue_no` (`issue_no`),
  ADD KEY `idx_issue_wh` (`warehouse_id`),
  ADD KEY `idx_issue_status` (`status`),
  ADD KEY `fk_issue_partner` (`partner_id`),
  ADD KEY `fk_issue_counter` (`counter_account_id`),
  ADD KEY `fk_issue_voucher` (`acc_voucher_id`);
...
ALTER TABLE `goods_issue_items`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_ii_issue` (`issue_id`),
  ADD KEY `idx_ii_part` (`part_id`);
...
ALTER TABLE `goods_receipts`
  ...
  ADD KEY `idx_receipt_wh` (`warehouse_id`),
  ADD KEY `idx_receipt_status` (`status`),
  ADD KEY `fk_receipt_partner` (`partner_id`),
  ADD KEY `fk_receipt_counter` (`counter_account_id`),
  ADD KEY `fk_receipt_voucher` (`acc_voucher_id`);
...
ALTER TABLE `goods_receipt_items`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_ri_receipt` (`receipt_id`),
  ADD KEY `idx_ri_part` (`part_id`),
  ADD KEY `fk_ri_location` (`location_id`);
...
ALTER TABLE `news`
  ...
  ADD KEY `idx_news_pub` (`is_published`,`published_at`);
...
ALTER TABLE `news_categories`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uq_news_cat_slug` (`slug`);
...
ALTER TABLE `orders`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uq_order_no` (`order_no`),
  ADD KEY `idx_order_member` (`member_id`),
  ADD KEY `idx_order_status` (`status`),
  ADD KEY `fk_order_invoice` (`sales_invoice_id`);
...
ALTER TABLE `partners`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uq_partners_code` (`code`),
  ADD KEY `idx_partners_type` (`type`),
  ADD KEY `fk_partners_group` (`group_id`);
...
ALTER TABLE `parts`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uq_parts_code` (`code`),
  ADD UNIQUE KEY `uq_parts_slug` (`slug`),
  ADD KEY `idx_parts_category` (`category_id`),
  ADD KEY `idx_parts_brand` (`brand_id`),
  ADD KEY `idx_parts_status` (`status`),
  ADD KEY `idx_parts_oem` (`oem_code`),
  ADD KEY `fk_parts_manufacturer` (`manufacturer_id`),
  ADD KEY `fk_parts_origin` (`origin_id`),
  ADD KEY `fk_parts_unit` (`unit_id`);

--
-- Indexes for table `part_attribute_values`
--
ALTER TABLE `part_attribute_values`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uq_pav_part_attr` (`part_id`,`attribute_id`),
  ADD KEY `idx_pav_attr` (`attribute_id`),
  ADD KEY `idx_pav_value` (`value`);
...
ALTER TABLE `part_categories`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uq_part_categories_slug` (`slug`),
  ADD KEY `idx_part_categories_parent` (`parent_id`);

--
-- Indexes for table `part_fitments`
--
ALTER TABLE `part_fitments`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uq_fitment` (`part_id`,`car_year_id`),
  ADD KEY `idx_fitment_car_year` (`car_year_id`);
...
ALTER TABLE `part_images`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_part_images_part` (`part_id`);

--
-- Indexes for table `part_related`
--
ALTER TABLE `part_related`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uq_part_related` (`part_id`,`related_part_id`),
  ADD KEY `idx_part_related_part` (`part_id`),
  ADD KEY `idx_part_related_related` (`related_part_id`);
...
ALTER TABLE `product_brands`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uq_product_brands_slug` (`slug`);
...
ALTER TABLE `product_manufacturers`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uq_product_manufacturers_slug` (`slug`);
...
ALTER TABLE `product_origins`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uq_product_origins_slug` (`slug`);
...
ALTER TABLE `product_reviews`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_review_part` (`part_id`,`status`),
...
ALTER TABLE `product_units`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uq_product_units_slug` (`slug`);
...
ALTER TABLE `quotations`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uq_quote_no` (`quote_no`),
...
ALTER TABLE `quotation_items`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_qi_quote` (`quotation_id`),
  ADD KEY `idx_qi_part` (`part_id`);
...
ALTER TABLE `sales_invoices`
  ...
  ADD KEY `idx_inv_customer` (`customer_id`),
  ADD KEY `idx_inv_status` (`status`),
  ADD KEY `fk_inv_warehouse` (`warehouse_id`),
  ADD KEY `fk_inv_quote` (`quotation_id`),
  ADD KEY `fk_inv_voucher` (`acc_voucher_id`);
...
ALTER TABLE `site_settings`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uq_settings_key` (`skey`);
...
ALTER TABLE `stocks`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uq_stock_wh_part` (`warehouse_id`,`part_id`),
  ADD KEY `idx_stocks_part` (`part_id`);
...
ALTER TABLE `stock_cards`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_cards_wh_part` (`warehouse_id`,`part_id`,`id`),
  ADD KEY `idx_cards_doc` (`doc_type`,`doc_id`),
  ADD KEY `idx_cards_part_date` (`part_id`,`move_date`);
...
ALTER TABLE `stock_reservations`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_resv_order` (`order_id`),
  ADD KEY `idx_resv_part` (`part_id`);
...
ALTER TABLE `stock_takes`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uq_take_no` (`take_no`),
  ADD KEY `idx_take_wh` (`warehouse_id`),
  ADD KEY `fk_take_voucher` (`acc_voucher_id`);
...
ALTER TABLE `stock_take_items`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_sti_take` (`take_id`),
  ADD KEY `idx_sti_part` (`part_id`);
...
ALTER TABLE `visits`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_visit_date` (`create_at`),
...
ALTER TABLE `warehouse_locations`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_wl_wh` (`warehouse_id`),
  ADD KEY `idx_wl_parent` (`parent_id`);
...
ALTER TABLE `warehouse_transfer_items`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_ti_transfer` (`transfer_id`),
  ADD KEY `idx_ti_part` (`part_id`);

--
-- Indexes for table `warranty_handovers`
--
ALTER TABLE `warranty_handovers`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uq_handover_no` (`handover_no`),
  ADD KEY `idx_handover_warranty` (`warranty_id`);
...
ALTER TABLE `warranty_requests`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uq_warranty_no` (`request_no`),
  ADD KEY `idx_warranty_status` (`status`),
  ADD KEY `idx_warranty_partner` (`partner_id`),
  ADD KEY `fk_warranty_part` (`part_id`);
...
--
-- AUTO_INCREMENT for table `acc_cost_items`
--
ALTER TABLE `acc_cost_items`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `acc_projects`
--
ALTER TABLE `acc_projects`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `part_attribute_values`
--
ALTER TABLE `part_attribute_values`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
-- AUTO_INCREMENT for table `part_fitments`
--
ALTER TABLE `part_fitments`
...
--
-- AUTO_INCREMENT for table `part_related`
--
ALTER TABLE `part_related`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
-- AUTO_INCREMENT for table `warranty_handovers`
--
ALTER TABLE `warranty_handovers`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `acc_accounts`
  ADD CONSTRAINT `fk_acc_accounts_parent` FOREIGN KEY (`parent_id`) REFERENCES `acc_accounts` (`id`) ON UPDATE CASCADE;

--
-- Constraints for table `acc_vouchers`
--
ALTER TABLE `acc_vouchers`
  ADD CONSTRAINT `fk_acc_vouchers_cash` FOREIGN KEY (`cash_account_id`) REFERENCES `acc_accounts` (`id`) ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_acc_vouchers_partner` FOREIGN KEY (`partner_id`) REFERENCES `partners` (`id`) ON DELETE SET NULL ON UPDATE CASCADE;

--
-- Constraints for table `acc_voucher_entries`
--
ALTER TABLE `acc_voucher_entries`
  ADD CONSTRAINT `fk_ave_account` FOREIGN KEY (`account_id`) REFERENCES `acc_accounts` (`id`) ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_ave_cost_item` FOREIGN KEY (`cost_item_id`) REFERENCES `acc_cost_items` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_ave_credit` FOREIGN KEY (`credit_account_id`) REFERENCES `acc_accounts` (`id`) ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_ave_debit` FOREIGN KEY (`debit_account_id`) REFERENCES `acc_accounts` (`id`) ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_ave_project` FOREIGN KEY (`project_id`) REFERENCES `acc_projects` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_ave_voucher` FOREIGN KEY (`voucher_id`) REFERENCES `acc_vouchers` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `car_models`
--
ALTER TABLE `car_models`
  ADD CONSTRAINT `fk_car_models_body` FOREIGN KEY (`body_type_id`) REFERENCES `car_body_types` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_car_models_brand` FOREIGN KEY (`brand_id`) REFERENCES `car_brands` (`id`) ON UPDATE CASCADE;

--
-- Constraints for table `car_years`
--
ALTER TABLE `car_years`
  ADD CONSTRAINT `fk_car_years_model` FOREIGN KEY (`model_id`) REFERENCES `car_models` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `chat_conversations`
--
ALTER TABLE `chat_conversations`
  ADD CONSTRAINT `fk_chat_member` FOREIGN KEY (`member_id`) REFERENCES `members` (`id`) ON DELETE SET NULL ON UPDATE CASCADE;

--
-- Constraints for table `chat_messages`
--
ALTER TABLE `chat_messages`
  ADD CONSTRAINT `fk_msg_conv` FOREIGN KEY (`conversation_id`) REFERENCES `chat_conversations` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `employees`
--
ALTER TABLE `employees`
  ADD CONSTRAINT `fk_emp_dept` FOREIGN KEY (`department_id`) REFERENCES `departments` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_emp_pos` FOREIGN KEY (`position_id`) REFERENCES `positions` (`id`) ON DELETE SET NULL ON UPDATE CASCADE;

--
-- Constraints for table `gallery_items`
--
ALTER TABLE `gallery_items`
  ADD CONSTRAINT `fk_gi_gallery` FOREIGN KEY (`gallery_id`) REFERENCES `galleries` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `goods_issues`
--
ALTER TABLE `goods_issues`
  ADD CONSTRAINT `fk_issue_counter` FOREIGN KEY (`counter_account_id`) REFERENCES `acc_accounts` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_issue_partner` FOREIGN KEY (`partner_id`) REFERENCES `partners` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_issue_voucher` FOREIGN KEY (`acc_voucher_id`) REFERENCES `acc_vouchers` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_issue_warehouse` FOREIGN KEY (`warehouse_id`) REFERENCES `warehouses` (`id`) ON UPDATE CASCADE;

--
-- Constraints for table `goods_issue_items`
--
ALTER TABLE `goods_issue_items`
  ADD CONSTRAINT `fk_ii_issue` FOREIGN KEY (`issue_id`) REFERENCES `goods_issues` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_ii_part` FOREIGN KEY (`part_id`) REFERENCES `parts` (`id`) ON UPDATE CASCADE;

--
-- Constraints for table `goods_receipts`
--
ALTER TABLE `goods_receipts`
  ADD CONSTRAINT `fk_receipt_counter` FOREIGN KEY (`counter_account_id`) REFERENCES `acc_accounts` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_receipt_partner` FOREIGN KEY (`partner_id`) REFERENCES `partners` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_receipt_voucher` FOREIGN KEY (`acc_voucher_id`) REFERENCES `acc_vouchers` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_receipt_warehouse` FOREIGN KEY (`warehouse_id`) REFERENCES `warehouses` (`id`) ON UPDATE CASCADE;

--
-- Constraints for table `goods_receipt_items`
--
ALTER TABLE `goods_receipt_items`
  ADD CONSTRAINT `fk_ri_location` FOREIGN KEY (`location_id`) REFERENCES `warehouse_locations` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_ri_part` FOREIGN KEY (`part_id`) REFERENCES `parts` (`id`) ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_ri_receipt` FOREIGN KEY (`receipt_id`) REFERENCES `goods_receipts` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `leave_requests`
--
ALTER TABLE `leave_requests`
  ADD CONSTRAINT `fk_leave_emp` FOREIGN KEY (`employee_id`) REFERENCES `employees` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `menus`
--
ALTER TABLE `menus`
  ADD CONSTRAINT `fk_menu_parent` FOREIGN KEY (`parent_id`) REFERENCES `menus` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `news`
--
ALTER TABLE `news`
  ADD CONSTRAINT `fk_news_cat` FOREIGN KEY (`category_id`) REFERENCES `news_categories` (`id`) ON DELETE SET NULL ON UPDATE CASCADE;

--
-- Constraints for table `orders`
--
ALTER TABLE `orders`
  ADD CONSTRAINT `fk_order_invoice` FOREIGN KEY (`sales_invoice_id`) REFERENCES `sales_invoices` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_order_member` FOREIGN KEY (`member_id`) REFERENCES `members` (`id`) ON DELETE SET NULL ON UPDATE CASCADE;
...
ALTER TABLE `order_items`
  ...
  ADD CONSTRAINT `fk_oi_part` FOREIGN KEY (`part_id`) REFERENCES `parts` (`id`) ON DELETE SET NULL ON UPDATE CASCADE;

--
-- Constraints for table `partners`
--
ALTER TABLE `partners`
  ADD CONSTRAINT `fk_partners_group` FOREIGN KEY (`group_id`) REFERENCES `customer_groups` (`id`) ON DELETE SET NULL ON UPDATE CASCADE;

--
-- Constraints for table `parts`
--
ALTER TABLE `parts`
  ADD CONSTRAINT `fk_parts_brand` FOREIGN KEY (`brand_id`) REFERENCES `product_brands` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_parts_category` FOREIGN KEY (`category_id`) REFERENCES `part_categories` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_parts_manufacturer` FOREIGN KEY (`manufacturer_id`) REFERENCES `product_manufacturers` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_parts_origin` FOREIGN KEY (`origin_id`) REFERENCES `product_origins` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_parts_unit` FOREIGN KEY (`unit_id`) REFERENCES `product_units` (`id`) ON DELETE SET NULL ON UPDATE CASCADE;

--
-- Constraints for table `part_attribute_values`
--
ALTER TABLE `part_attribute_values`
  ADD CONSTRAINT `fk_pav_attr` FOREIGN KEY (`attribute_id`) REFERENCES `attributes` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_pav_part` FOREIGN KEY (`part_id`) REFERENCES `parts` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `part_categories`
--
ALTER TABLE `part_categories`
  ADD CONSTRAINT `fk_part_categories_parent` FOREIGN KEY (`parent_id`) REFERENCES `part_categories` (`id`) ON UPDATE CASCADE;

--
-- Constraints for table `part_fitments`
--
ALTER TABLE `part_fitments`
  ADD CONSTRAINT `fk_fitment_car_year` FOREIGN KEY (`car_year_id`) REFERENCES `car_years` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_fitment_part` FOREIGN KEY (`part_id`) REFERENCES `parts` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `part_images`
--
ALTER TABLE `part_images`
  ADD CONSTRAINT `fk_part_images_part` FOREIGN KEY (`part_id`) REFERENCES `parts` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `part_related`
--
ALTER TABLE `part_related`
  ADD CONSTRAINT `fk_part_related_part` FOREIGN KEY (`part_id`) REFERENCES `parts` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_part_related_related` FOREIGN KEY (`related_part_id`) REFERENCES `parts` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `product_reviews`
--
ALTER TABLE `product_reviews`
  ADD CONSTRAINT `fk_review_member` FOREIGN KEY (`member_id`) REFERENCES `members` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_review_part` FOREIGN KEY (`part_id`) REFERENCES `parts` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `quotations`
--
ALTER TABLE `quotations`
  ADD CONSTRAINT `fk_quote_customer` FOREIGN KEY (`customer_id`) REFERENCES `partners` (`id`) ON DELETE SET NULL ON UPDATE CASCADE;

--
-- Constraints for table `quotation_items`
--
ALTER TABLE `quotation_items`
  ADD CONSTRAINT `fk_qi_part` FOREIGN KEY (`part_id`) REFERENCES `parts` (`id`) ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_qi_quote` FOREIGN KEY (`quotation_id`) REFERENCES `quotations` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `sales_invoices`
--
ALTER TABLE `sales_invoices`
  ADD CONSTRAINT `fk_inv_customer` FOREIGN KEY (`customer_id`) REFERENCES `partners` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_inv_quote` FOREIGN KEY (`quotation_id`) REFERENCES `quotations` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_inv_voucher` FOREIGN KEY (`acc_voucher_id`) REFERENCES `acc_vouchers` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_inv_warehouse` FOREIGN KEY (`warehouse_id`) REFERENCES `warehouses` (`id`) ON UPDATE CASCADE;

--
-- Constraints for table `sales_invoice_items`
--
ALTER TABLE `sales_invoice_items`
  ADD CONSTRAINT `fk_sii_invoice` FOREIGN KEY (`invoice_id`) REFERENCES `sales_invoices` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_sii_part` FOREIGN KEY (`part_id`) REFERENCES `parts` (`id`) ON UPDATE CASCADE;

--
-- Constraints for table `stocks`
--
ALTER TABLE `stocks`
  ADD CONSTRAINT `fk_stocks_part` FOREIGN KEY (`part_id`) REFERENCES `parts` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_stocks_warehouse` FOREIGN KEY (`warehouse_id`) REFERENCES `warehouses` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `stock_cards`
--
ALTER TABLE `stock_cards`
  ADD CONSTRAINT `fk_cards_part` FOREIGN KEY (`part_id`) REFERENCES `parts` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_cards_warehouse` FOREIGN KEY (`warehouse_id`) REFERENCES `warehouses` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `stock_reservations`
--
ALTER TABLE `stock_reservations`
  ADD CONSTRAINT `fk_resv_order` FOREIGN KEY (`order_id`) REFERENCES `orders` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_resv_part` FOREIGN KEY (`part_id`) REFERENCES `parts` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `stock_takes`
--
ALTER TABLE `stock_takes`
  ADD CONSTRAINT `fk_take_voucher` FOREIGN KEY (`acc_voucher_id`) REFERENCES `acc_vouchers` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_take_warehouse` FOREIGN KEY (`warehouse_id`) REFERENCES `warehouses` (`id`) ON UPDATE CASCADE;

--
-- Constraints for table `stock_take_items`
--
ALTER TABLE `stock_take_items`
  ADD CONSTRAINT `fk_sti_part` FOREIGN KEY (`part_id`) REFERENCES `parts` (`id`) ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_sti_take` FOREIGN KEY (`take_id`) REFERENCES `stock_takes` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `warehouse_locations`
--
ALTER TABLE `warehouse_locations`
  ADD CONSTRAINT `fk_wl_parent` FOREIGN KEY (`parent_id`) REFERENCES `warehouse_locations` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_wl_warehouse` FOREIGN KEY (`warehouse_id`) REFERENCES `warehouses` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `warehouse_transfers`
--
ALTER TABLE `warehouse_transfers`
  ADD CONSTRAINT `fk_transfer_from` FOREIGN KEY (`from_warehouse_id`) REFERENCES `warehouses` (`id`) ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_transfer_to` FOREIGN KEY (`to_warehouse_id`) REFERENCES `warehouses` (`id`) ON UPDATE CASCADE;

--
-- Constraints for table `warehouse_transfer_items`
--
ALTER TABLE `warehouse_transfer_items`
  ADD CONSTRAINT `fk_ti_part` FOREIGN KEY (`part_id`) REFERENCES `parts` (`id`) ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_ti_transfer` FOREIGN KEY (`transfer_id`) REFERENCES `warehouse_transfers` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `warranty_handovers`
--
ALTER TABLE `warranty_handovers`
  ADD CONSTRAINT `fk_handover_warranty` FOREIGN KEY (`warranty_id`) REFERENCES `warranty_requests` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `warranty_requests`
--
ALTER TABLE `warranty_requests`
  ADD CONSTRAINT `fk_warranty_part` FOREIGN KEY (`part_id`) REFERENCES `parts` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_warranty_partner` FOREIGN KEY (`partner_id`) REFERENCES `partners` (`id`) ON DELETE SET NULL ON UPDATE CASCADE;
COMMIT;
