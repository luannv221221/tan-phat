...
| | |
|---|---|
| **Trạng thái** | ✅ Đã duyệt (TT133 · công nợ dùng bảng `partners` chung · VND · nhập tay) · **KT-1→KT-5 đã code + verify** (18/07) ✅ · KT-6 (tự sinh bút toán từ Kho/Bán hàng) hoãn tới khi có 2 phân hệ đó |
| **Ngày** | 18/07/2026 |
...
| ~~**KT-5**~~ | Sổ sách: Nhật ký chung, Sổ cái/chi tiết TK | ✅ Xong 18/07 — tính động từ getPostedLedger; số dư đầu/cuối kỳ + luỹ kế |
