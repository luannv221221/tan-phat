...
| | |
|---|---|
| **Trạng thái** | ✅ Đã duyệt (TT133 · công nợ dùng bảng `partners` chung · VND · nhập tay) · **KT-1, KT-2, KT-3 đã code + verify** (18/07) · KT-4 (công nợ) + KT-5 (sổ sách) tiếp theo · KT-6 hoãn (chờ Kho/Bán hàng) |
| **Ngày** | 18/07/2026 |
