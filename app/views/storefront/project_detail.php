...
<div class="card"><div class="bd">
    ...
    <img src="{{media_url($project['thumbnail'])}}" alt="{{$project['name']}}" style="width:100%;border-radius:8px;margin-bottom:16px"/>
    @endif
...
<div class="grid">
    @foreach ($others as $o)
    <?php $thumb = !empty($o['thumbnail']) ? '<img src="'.e(media_url($o['thumbnail'])).'" alt="'.e($o['name']).'" style="width:100%;height:100%;object-fit:cover"/>' : '🏗'; ?>
    <div class="pcard">
