            ...
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="name" placeholder="VD: Toyota" value="{{!empty($old['name'])?$old['name']:''}}"/>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="country" placeholder="VD: Nhật Bản" value="{{!empty($old['country'])?$old['country']:''}}"/>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <small class="form-text text-muted">JPG, PNG, GIF, WEBP · tối đa 2MB.</small>
