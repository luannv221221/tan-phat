<div class="container py-3">
    ...
    <form action="" method="post">
        ...
        <div class="form-group">
            ...
            <input type="password" class="form-control" name="password" placeholder="Mật khẩu (Không nhập thì không đổi mật khẩu)..." value=""/>
            {!! !empty($errors['password'])?'<span style="color:red">'.$errors['password'].'</span>':false !!}
        </div>

        <div class="form-group">
            <label for="">Nhập lại mật khẩu</label>
            <input type="password" class="form-control" name="confirm_password" placeholder="Nhập lại mật khẩu (Không nhập thì không đổi mật khẩu)..." value=""/>
