...
<div class="card card-outline card-primary">
    <div class="card-header">
        <h3 class="card-title"><i class="fas fa-warehouse mr-2"></i>{{$page_name}}</h3>
        ...
        <table class="table table-hover text-nowrap mb-0">
            <thead>
                <tr>
                    ...
                    <th style="width:110px" class="text-center">Mặc định</th>
            ...
            @if (!empty($dataList))
                ...
                <tr>
                    ...
                    <td class="text-center">
                        {!! $item['is_default']==1 ? '<span class="badge badge-info">Mặc định</span>' : '' !!}
                    </td>
                    <td class="text-center">
            ...
            @else
                <tr>
                    <td colspan="8" class="text-center text-muted py-4">
                        <i class="fas fa-inbox fa-2x d-block mb-2"></i> Chưa có kho nào
                    </td>
                </tr>
            @endif
            </tbody>
