...
$selType = !empty($old['type']) ? $old['type'] : 'xuat_ban';
?>
<form action="" method="post">
    ...
    <div class="card card-outline card-danger">
        <div class="card-header"><h3 class="card-title"><i class="fas fa-dolly mr-2"></i>{{$page_name}}</h3></div>
        <div class="card-body">
            <div class="form-row">
                ...
                <div class="form-group col-md-3">
                    ...
                    <input type="date" name="issue_date" class="form-control" value="{{!empty($old['issue_date'])?$old['issue_date']:$today}}"/>
