...
<div class="card card-outline card-primary">
    <div class="card-header">
        <h3 class="card-title"><i class="fas fa-tags mr-2"></i>{{$page_name}}</h3>
            ...
            @if (!empty($dataList))
                ...
                <tr>
                    ...
                    <td class="text-center">
                        ...
                        <a onclick="return confirm('Bạn có chắc chắn muốn xoá?')" href="{{_WEB_URL.'/admin/'.$routeBase.'/delete/'.$item['id']}}" class="btn btn-danger btn-sm" title="Xoá"><i class="fas fa-trash"></i></a>
                        @endif
                    </td>
                </tr>
                @endforeach
            @else
                <tr><td colspan="6" class="text-center text-muted py-4"><i class="fas fa-inbox fa-2x d-block mb-2"></i> Chưa có dữ liệu</td></tr>
            @endif
            </tbody>
        </table>
    </div>
