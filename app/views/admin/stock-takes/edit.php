...
@if ($posted)
    ...
    <div class="card card-outline card-info">
        ...
        <div class="card-body table-responsive p-0">
            <table class="table table-sm mb-0">
                <thead><tr><th>Hàng hoá</th><th class="text-right">Tồn sổ</th><th class="text-right">Thực tế</th><th class="text-right">Chênh lệch</th><th class="text-right">Giá vốn/đv</th><th class="text-right">Giá trị lệch</th></tr></thead>
                <tbody>
                @foreach ($items as $it)
    ...
    <div class="card"><div class="card-body">
        ...
        <a href="{{_WEB_URL.'/admin/'.$routeBase.'/unpost/'.$item['id']}}" onclick="return confirm('Huỷ chốt sẽ hoàn lại tồn kho. Tiếp tục?')" class="btn btn-warning"><i class="fas fa-unlock mr-1"></i> Huỷ chốt</a>
        @endif
...
@else
    ...
    (function () {
        ...
        function addRow(data){
            ...
            tr.appendChild(td(soDem(inp('line_actual[]','text-right',data.actual))));
