...
<form action="" method="post">
    ...
    <div class="card card-outline card-warning">
        <div class="card-header"><h3 class="card-title"><i class="fas fa-clipboard-check mr-2"></i>{{$page_name}}</h3></div>
        <div class="card-body">
            <div class="form-row">
                <div class="form-group col-md-3">
                    <label>Ngày <span class="text-danger">*</span></label>
                    <input type="date" name="take_date" class="form-control" value="{{!empty($old['take_date'])?$old['take_date']:$today}}"/>
