...
$selectedModel = !empty($old['model_id']) ? (int) $old['model_id'] : 0;
?>
                ...
                <div class="card-body">
                    ...
                    <div class="form-row">
                        <div class="form-group col-6">
                            ...
                            <input type="number" class="form-control" name="year_from" placeholder="VD: 2018" value="{{!empty($old['year_from'])?$old['year_from']:''}}"/>
                            {!! !empty($errors['year_from'])?'<small class="text-danger">'.e($errors['year_from']).'</small>':false !!}
                        </div>
                        <div class="form-group col-6">
                            <label>Năm kết thúc</label>
                            <input type="number" class="form-control" name="year_to" placeholder="Bỏ trống = đến nay" value="{{!empty($old['year_to'])?$old['year_to']:''}}"/>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="name" placeholder="Bỏ trống sẽ tự sinh, VD: Vios 2018–2023" value="{{!empty($old['name'])?$old['name']:''}}"/>
                    </div>
