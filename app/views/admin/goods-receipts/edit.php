    ...
    <div class="card card-outline card-info">
        ...
        <div class="card-body table-responsive p-0">
            <table class="table table-sm mb-0">
                <thead><tr><th>Hàng hoá</th><th class="text-right">Số lượng</th><th class="text-right">Đơn giá</th><th class="text-right">Thành tiền</th><th>Vị trí</th></tr></thead>
                <tbody>
                @foreach ($items as $it)
                <tr>
...
@else
    ...
    (function () {
        ...
        function addRow(data){
            ...
            var c = oTien(inp('line_cost[]','cost text-right',data.cost)); c.addEventListener('input', recompute); tr.appendChild(td(c));
