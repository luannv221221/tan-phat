        ...
        <table class="table table-hover text-nowrap mb-0">
            <thead>
                <tr>
                    ...
                    <th style="width:80px" class="text-center">Màu</th>
                ...
                <tr>
                    ...
                    <td><code>{{$item['slug']}}</code></td>
                        <td class="text-center">
                            {!! !empty($item['hex']) ? '<span class="tp-swatch" style="background:'.e($item['hex']).'" title="'.e($item['hex']).'"></span>' : '<span class="text-muted">-</span>' !!}
                        </td>
