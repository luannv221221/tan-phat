    ...
    <div class="card card-outline card-primary">
        ...
        <form action="" method="post">
            ...
            <div class="card-body">
                ...
                @endif
                <div class="form-row">
                    <div class="form-group col-md-4"><label>Mã</label><input type="text" name="code" class="form-control" value="{{!empty($old['code'])?$old['code']:''}}"/></div>
                ...
                <div class="form-group"><label>Mô tả</label><input type="text" name="description" class="form-control" value="{{!empty($old['description'])?$old['description']:''}}"/></div>
                <div class="form-group"><label>Thứ tự</label><input type="number" name="sort_order" class="form-control" style="max-width:150px" value="{{!empty($old['sort_order'])?$old['sort_order']:'0'}}"/></div>
