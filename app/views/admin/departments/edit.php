    ...
    <div class="card card-outline card-warning">
        ...
        <form action="" method="post">
            ...
            <div class="card-body">
                ...
                @endif
                <div class="form-row">
                    <div class="form-group col-md-4"><label>Mã</label><input type="text" name="code" class="form-control" value="{{$v('code')}}"/></div>
                ...
                <div class="form-group"><label>Mô tả</label><input type="text" name="description" class="form-control" value="{{$v('description')}}"/></div>
                <div class="form-group"><label>Thứ tự</label><input type="number" name="sort_order" class="form-control" style="max-width:150px" value="{{$v('sort_order','0')}}"/></div>
