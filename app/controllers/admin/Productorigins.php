 ...
 */
class Productorigins extends Controller {

    private $__data = [];
    private $__model, $__request, $__response;

    private $routeBase = 'product-origins';
    private $labelOne  = 'xuất xứ';
    private $labelMany = 'Xuất xứ';
    private $viewDir   = 'admin/product-origins';

    function __construct(){
        $this->__model    = $this->model('ProductOriginsModel');
