 ...
 */
class Carbodytypes extends Controller {

    private $__data = [];
    private $__model, $__request, $__response;

    private $routeBase = 'car-body-types';
    private $labelOne  = 'dòng xe';
    private $labelMany = 'Dòng xe (kiểu dáng)';
    private $viewDir   = 'admin/car-body-types';

    function __construct(){
        $this->__model    = $this->model('CarBodyTypesModel');
