...
class Departments extends Controller {
    ...
    private $routeBase = 'departments';
    private $labelOne  = 'phòng ban';
    private $labelMany = 'Phòng ban';
    private $viewDir   = 'admin/departments';

    function __construct(){
        $this->__model    = $this->model('DepartmentsModel');
    ...
    private function buildData(){
        ...
        return [
            'code'        => !empty($f['code']) ? trim($f['code']) : null,
            'name'        => trim($f['name']),
