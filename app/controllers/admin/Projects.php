...
/** KT-1 — Mã vụ việc (code + name). Cùng khuôn với Costitems, khác model + nhãn. */
class Projects extends Controller {

    private $__data = [];
    private $__model, $__request, $__response;

    private $routeBase = 'projects';
    private $labelOne  = 'mã vụ việc';
    private $labelMany = 'Danh mục mã vụ việc';
    private $viewDir   = 'admin/acc-codename';

    function __construct(){
        $this->__model    = $this->model('AccProjectsModel');
