 ...
 */
class Productmanufacturers extends Controller {

    private $__data = [];
    private $__model, $__request, $__response;

    private $routeBase = 'product-manufacturers';
    private $labelOne  = 'hãng sản xuất';
    private $labelMany = 'Hãng sản xuất';
    private $viewDir   = 'admin/product-manufacturers';

    function __construct(){
        $this->__model    = $this->model('ProductManufacturersModel');
